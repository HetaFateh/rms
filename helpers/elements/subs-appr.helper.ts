/**
 * helpers/elements/subs-appr.helper.ts
 * ──────────────────────────────────────────────────────────────────────────────
 * Locators and action helpers for the Subscription Approval feature.
 *
...
export const subsApprNavElements = (page: Page) => ({
  btnManageProgram:       sidebarElements(page).btnManageProgram,
  linkSubscribeApproval:  sidebarElements(page).linkSubscribeApproval,
});

// ── TODO: Add page-specific element factories here ────────────────────────────
// export const subsApprListElements = (page: Page) => ({ ... });

// ── TODO: Add high-level action helpers here ──────────────────────────────────
// export async function approveSubscription(page: Page, id: string): Promise<void> { ... }
